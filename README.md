...
=============
    ...
    2. Open a command prompt and navigate to the JavaSDK/MarvelComicsLib folder.
    ...
    4.In your own maven application, add the following lines which will refer to newly installed SDK: 
        <dependency>
            <groupId>MarvelComicsLib</groupId>
            <artifactId>MarvelComicsLib</artifactId>
...
Exporting JARs:
    ...
    3. Check the box beside "MarvelComicsLib" and click on "Finish".
